...
**v0.2.0** — tray Start/Stop via on-demand UAC, optional tray logon startup scripts, plus the
v0.1.0 service + tray packaging baseline. Validated end‑to‑end with the VPN connected.
